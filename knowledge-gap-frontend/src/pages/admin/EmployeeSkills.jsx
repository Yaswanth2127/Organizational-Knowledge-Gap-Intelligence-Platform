...
import AssignEmployeeSkillModal from "../../components/employee/skills/AssignEmployeeSkillModal";
...
export default function EmployeeSkills() {
    ...
    */
    ...
    const handleAssignSkill = async (formData) => {
        ...
        try {
            ...
            const request = {
                ...
                selfRating: formData.initialLevel,
                peerRating: formData.initialLevel,
                managerRating: formData.initialLevel,
                finalRating: formData.initialLevel,
            };

            await assignEmployeeSkill(formData.userId, request);
        ...
        error.response?.data ||
        "Unable to assign employee skill.";
