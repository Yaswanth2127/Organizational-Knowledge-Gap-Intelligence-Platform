...
//                     <input type="text" value={name} onChange={(e) => setName(e.target.value)} required style={{ width: '100%', padding: '8px', marginTop: '5px', border:'1px solid #111', borderRadius:'0.5rem' }} />
//                 </div>
//                 <div style={{ marginBottom: '15px' }}>
//                     <label>Email:</label>
//                     <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required style={{ width: '100%', padding: '8px', marginTop: '5px', border:'1px solid #111', borderRadius:'0.5rem' }} />
//                 </div>
//                 <div style={{ marginBottom: '15px' }}>
//                     <label>Password:</label>
//                     <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required style={{ width: '100%', padding: '8px', marginTop: '5px',border:'1px solid #111', borderRadius:'0.5rem' }} />
//                 </div>
