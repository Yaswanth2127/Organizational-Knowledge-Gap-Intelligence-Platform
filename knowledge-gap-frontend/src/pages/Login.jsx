...
//     return (
//         <div style={{ maxWidth: '350px', margin: '50px auto', padding: '20px', border: '1px solid #111', borderRadius:'0.5rem', fontFamily: 'Arial' }}>
//             <h2 style={{textAlign:'center'}}>Login - Knowledge Gap Platform</h2>
//             <form onSubmit={handleSubmit}>
//                 <div style={{ marginBottom: '15px'}}>
//                     <label>Email:</label>
//                     <input type="email" placeholder='Enter your e-mail' value={email} onChange={(e) => setEmail(e.target.value)} required style={{ width: '100%', padding: '8px', marginTop: '5px', border:'1px solid #111', borderRadius:'0.5rem' }} />
//                 </div>
//                 <div style={{ marginBottom: '15px' }}>
//                     <label>Password:</label>
//                     <input type="password" placeholder='Enter your password' value={password} onChange={(e) => setPassword(e.target.value)} required style={{ width: '100%', padding: '8px', marginTop: '5px', border:'1px solid #111', borderRadius:'0.5rem' }} />
//                 </div>
